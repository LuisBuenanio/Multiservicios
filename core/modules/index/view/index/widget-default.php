...
<a href="index1.php?action=addtocart&product_id=<?php echo $p->id; ?>&href=cat" class="btn btn-labeled btn-primary tip" title="A&ntilde;adir al carrito">
...
<br>
<?php endif; ?>
<a href="index1.php?view=producto&product_id=<?php echo $p->id; ?>">Detalles</a>
                </center>
