...
<?php foreach($cats as $cat):?>
  ...
  <a href="index1.php?view=productos&cat=<?php echo $cat->short_name; ?>" class="list-group-item"><i class="fa fa-chevron-right"></i>  <?php echo $cat->name; ?></a>
<?php endforeach; ?>
</div>
<?php endif; ?>
      </div>
...
<?php elseif(!$in_cart):?>
<a href="index1.php?action=addtocart&product_id=<?php echo $p->id; ?>&href=product" class="btn btn-labeled btn-primary tip" title="A&ntilde;adir al carrito">
                <span><i class="fa fa-shopping-cart"></i></span> Comprar</a>
<?php else:?>
<a href="index1.php?action=addtocart&product_id=<?php echo $p->id; ?>&href=product" class="btn btn-labeled btn-success tip" title="Ya esta en el carrito">
