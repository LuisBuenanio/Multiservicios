                ...
                <tr>
                    ...
                    <td style="width:100px;">
                        ...
                        $("#num-<?=$s['product_id'];?>").change(function() {
                            $.post("./?action=editcart", $("#p-<?=$s['product_id']?>").serialize(), function(
                                data) {
                    ...
                    <td>
                        <h4><?php echo $coin_symbol; ?> <?php echo $p->price; ?></h4>
                    </td>
                    <td>
                        <h4><?php echo $coin_symbol; ?> <?php echo $p->price*$s["q"]; ?></h4>
                    </td>
                    <td style="width:30px;"><a
                            href="index1.php?action=deletefromcart&product_id=<?php echo $p->id; ?>&href=cart"
 ...
 endforeach; ?>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-2">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><?php echo $coin_symbol; ?>
                                <?php echo number_format($total-($total*($iva/100)),2,".",","); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $ivatxt; ?></td>
                            <td><?php echo $coin_symbol; ?> <?php echo number_format($total*($iva/100),2,".",","); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>Total</td>
                            <td><?php echo $coin_symbol; ?> <?php echo number_format($total,2,".",","); ?></td>
                        </tr>
                    ...
                    <br>
                    <?php if(isset($_SESSION["client_id"])):?>
                    <form action="index1.php?view=checkout" method="post">
                    ...
                    <?php endif; ?>
                    <br>
                    <a href="index1.php?action=cleancart" class="btn btn-danger btn-block">Limpar Carrito</a>
                </div>
            </div>
