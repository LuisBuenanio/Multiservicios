...
<h3>Bienvenido, <?php echo $client->name." ".$client->lastname; ?></h3>
	<a href="./index1.php?view=client" class="btn btn-secondary"><i class="fa fa-chevron-left"></i> Regresar</a>
...
$px = $p->getProduct();
	?>
	<tr>
		<td><a href="index1.php?view=producto&product_id=<?php echo $px->id; ?>">Detalles</a></td>
		<td><?php echo $p->q; ?></td>
...
<?php if($buy->status_id==1):?>
<form method="post" action="index1.php?action=cancelbuy">
