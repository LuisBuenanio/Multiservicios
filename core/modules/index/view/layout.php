...
<head>
  ...
  <title>MULTISERVICIOS JHOSUE</title>
...
<section>
  <div class="container">
    ...
    <div class="col-xs-0 col-md-0"></div>
      <br><h1>MULTISERVICIOS JHOSUE</h1>
      </div>
      <div class="col-md-0 col-xs-">
<!---
...
<?php foreach($cats as $cat):?>
          <a class="dropdown-item" href="index1.php?view=productos&cat=<?php echo $cat->short_name; ?>"><?php echo $cat->name; ?></a>
<?php endforeach; ?>
        </div>
      </li>
    <?php endif; ?>
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="index1.php?view=client">Mi cuenta</a>
          <a class="dropdown-item" href="logout.php">Salir</a>
            <?php else:?>
          <a class="dropdown-item" href="index1.php?view=clientaccess">Iniciar sesion</a>
          <a class="dropdown-item" href="index1.php?view=register">Registro</a>
        <?php endif; ?>
        </div>
      </li>
...
&nbsp;
<a href="index1.php?view=mycart" class="btn  btn-secondary my-2 my-sm-0"><i class="fa fa-shopping-cart"></i> 
...
<div class="col-md-12">
<hr>
<p><b>ESPOCH</b> &copy; 2021</p>
<ul class="list-inline">
<li class="list-inline-item"><p class="text-muted"> <a href="http://espoch.edu.ec/">ESPOCH</a></p></li>
<li class="list-inline-item"><p class="text-muted"> <a href=" ">Documentacion</a></p></li>
</ul>
</div>
</div>
</div>
