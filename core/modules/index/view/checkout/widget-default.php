...
<br>
			<?php if(isset($_SESSION["client_id"])):?>
<form action="index1.php?action=buy" method="post">
...
<?php endif; ?>
<br>
<a href="index1.php?view=mycart" class="btn btn-warning btn-block">Regresar al Carrito</a>
<br><a href="index1.php?action=clearcart" class="btn btn-danger btn-block">Cancelar</a>
</div>
</div>
